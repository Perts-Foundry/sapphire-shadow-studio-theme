...
// covers announcement copy vs shipping settings, four dated vacation settings, the FAQ deep link,
// the price block's show_shipping_info per template, and the two hardcoded social lists;
// .claude/rules/theme-code.md (Translations) covers the two mirrored locales; the catalogue census
// vs template files is catalogue.json's own contract (see its comment field).
