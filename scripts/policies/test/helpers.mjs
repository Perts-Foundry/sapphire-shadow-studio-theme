...
import { UnexpectedGitInvocation, assertAllGitFakesExhausted, makeGitFake } from '../../lib/git-fake.mjs';
...
// The strict git fake moved to scripts/lib/git-fake.mjs when the article push needed the same
// guarantee. Re-exported as BINDINGS (not `export ... from`, which the import-closure guard refuses),
// so every test in this directory keeps importing it from here unchanged.
export { UnexpectedGitInvocation, assertAllGitFakesExhausted, makeGitFake };
