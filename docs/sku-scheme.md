...
colour on `lead-ii-crewneck` creates 60 variants (10 designs x 6 sizes) and needs exactly one new
table row; the tool then fills all 60. A half-populated SKU field is worse than an empty one,
